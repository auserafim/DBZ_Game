...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        image_player = pygame.image.load("/home/aurelio/Documents/projects/python_projects/asteroid_python_game/papaleguas.png")
        scaled_image_player = pygame.transform.scale(image_player, (image_player.get_width() / 5, image_player.get_height() / 5))

        super(Player, self).__init__()
        self.surf = scaled_image_player #Define o retangulo que representa o player
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        image_enemy = pygame.image.load("/home/aurelio/Documents/projects/python_projects/asteroid_python_game/coyote.png")
        scaled_image_enemy = pygame.transform.scale(image_enemy, (image_enemy.get_width() / 4, image_enemy.get_height() / 4))
        super(Enemy, self).__init__()
        self.surf = scaled_image_enemy #Preenche com cor branca (RGB)
        ...
        self.speed = random.uniform(1, 2) #Sorteia sua velocidade, entre 1 e 15
...
ADDENEMY = pygame.USEREVENT + 8
pygame.time.set_timer(ADDENEMY, 2000) #Define um intervalo para a criacao de cada inimigo (milisegundos)
...
background = pygame.image.load("/home/aurelio/Documents/projects/python_projects/asteroid_python_game/background.jpg")
